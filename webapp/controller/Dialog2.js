sap.ui.define([
	...
	return ManagedObject.extend("com.sap.build.standard.mRv4.controller.Dialog2", {
		constructor: function (oView) {
			this._oView = oView;
			this._oControl = sap.ui.xmlfragment(oView.getId(), "com.sap.build.standard.mRv4.view.Dialog2", this);
			this._bInit = false;
		},
		...
		convertTextToIndexFormatter: function (sTextValue) {
			var oRadioButtonGroup = this.byId(
				"sap_m_Dialog_1-content-build_simple_form_Form-1544920360749-formContainers-build_simple_form_FormContainer-1544920388429-formElements-build_simple_form_FormElement-3-fields-sap_m_RadioButtonGroup-1"
			);
